...
case_pred_outfile="case_predictions"
#case_pred_outfile="trainset_clindetails.txt"
KMplotfile="Survival_TestSet_RFRS.pdf"
...
clindata_plusRF[,"t_rfs"]=clindata_plusRF[,"time.to.relapse.or.last.follow.up..months."]

#Add column of 10yr censored data
clindata_plusRF[,"e_rfs_10yrcens"]=clindata_plusRF[,"relapse..1.True."]
clindata_plusRF[which(clindata_plusRF[,"t_rfs"]>120),"e_rfs_10yrcens"]=0
...
pdf(file=KMplotfile)
colors = rainbow(5)
title="Survival by RFRS - Not downsampled - trainingset"
plot(krfit.by_RFgroup, col = colors, xlab = "Time (Months)", ylab = "Relapse Free Survival", main=title, cex.axis=1.3, cex.lab=1.4)
